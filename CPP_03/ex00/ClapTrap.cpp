...
{
	if (this->HitPoints > 0 && this->EnergyPoints > 0 && this->HitPoints + amount <= 10)
	{
		this->EnergyPoints--;
		this->HitPoints += amount;
		...
		std::cout << "ClapTrap " << this->Name << " can't have more then 10 hit points, it has now " << this->HitPoints << " hit points!" << std::endl;
}
